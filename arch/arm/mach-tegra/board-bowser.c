...
/* Bowser use SPDIF_IN for VBUS_EN1 OC detection and controlling */
static void bowser_set_vbus_en1_tristate(bool on)
{
...
static struct tegra_xusb_board_data xusb_bdata = {
	...
	.set_vbus_en1_tristate = &bowser_set_vbus_en1_tristate,
};
